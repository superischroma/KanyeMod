...
@CommandParameters(name = "smite", description = "Smite that bitch down.", usage = "/<command> <player> [reason]", rank = Rank.SWING_ADMIN)
public class Command_smite extends SuperCommand
{
    @Override
    public boolean onCommand(CommandSender sender, Command cmd, String c, String[] args)
    {
        ...
        PunishmentList.logPunishment(player, PunishmentType.SMITE, sender, reason);
