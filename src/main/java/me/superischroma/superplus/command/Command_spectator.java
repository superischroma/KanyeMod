...
@CommandParameters(name = "spectator", description = "For people who want to move through everything. -Super", usage = "/<command> [player]", aliases = "gmsp", rank = Rank.SWING_ADMIN, source = Source.IN_GAME)
public class Command_spectator extends SuperCommand
{
    @Override
